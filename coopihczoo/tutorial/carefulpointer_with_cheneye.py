...
class ChenEyeObservationEngineWrapper(WrapAsObservationEngine):
    ...
    def observe(self, game_state=None):
        ...
        self.reset(dic=reset_dic, go_to=0)
        # perform the run
        is_done = False
        rewards = 0
        while True:
...
from coopihczoo.pointing.assistants.assistants import BIGGain, ConstantCDGain
...
game_state = bundle.reset(go_to=3)
