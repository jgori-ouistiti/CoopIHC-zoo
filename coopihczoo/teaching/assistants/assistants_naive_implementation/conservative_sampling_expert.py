...
#         raise NotImplementedError
from coopihczoo.teaching.assistants.assistants_naive_implementation.conservative_sampling import (
    ConservativeSampling,
)
from coopihczoo.teaching.assistants.assistants_naive_implementation.rl import (
    RlTeacherInferenceEngine,
)

# from coopihc import BaseAgent, RuleObservationEngine, oracle_engine_specification


class ConservativeSamplingExpert(ConservativeSampling):
    def __init__(self):
        super().__init__()
        # super().__init__(
        #     override_observation_engine=(
    ...
    def finit(self, *args, **kwargs):
        ...
        inference_engine = RlTeacherInferenceEngine(n_item=n_item)
