...
# filter in coopihc rather than in gym. Coopihc is more powerful (likely slower as well) because you can also observe only a given component e.g. slice(2,3,1) instead of Ellipsis
...
# env = TrainGym(
#     bundle, train_user=False, train_assistant=True, filter_observation=filterdict
# )
